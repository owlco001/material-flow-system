...
fun WorkspaceScreen(
    ...
    assemblyDeviceFilter: String? = null,
    assemblyMaterialStatus: com.company.logistics.model.OrderMaterialStatus? = null,
    assemblyMaterialState: WorkspaceLoadState = WorkspaceLoadState.IDLE,
    assemblyMaterialError: String? = null,
    ...
    onStartAssemblyStage: (AssemblyTask, Int) -> Unit = { _, _ -> },
    onCompleteAssemblyStage: (AssemblyTask, Int) -> Unit = { _, _ -> },
    onReworkAssemblyStage: (AssemblyTask, Int, String) -> Unit = { _, _, _ -> },
    ...
    if (role == UserRole.ASSEMBLER) {
        AssemblerWorkspaceScreen(
            ...
            deviceFilter = assemblyDeviceFilter,
            materialStatus = assemblyMaterialStatus,
            materialState = assemblyMaterialState,
            materialError = assemblyMaterialError,
            ...
            onStartStage = onStartAssemblyStage,
            onCompleteStage = onCompleteAssemblyStage,
            onReworkStage = onReworkAssemblyStage,
